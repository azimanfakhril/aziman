...
public class HealthActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    String country = "id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Berita Kesehatan");
    ...
    public void LoadJson(final String keyword) {
        ...
        if (keyword.length() > 0) {
            call = apiInterface.getNewsSearch(keyword, language, "health", API_KEY);
        } else {
    ...
    private void initListener() {
        ...
        adapter.setOnItemClickListener(new Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                ActivityOptionsCompat optionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation(HealthActivity.this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (query.length() > 2) {
                    ...
                    Toast.makeText(HealthActivity.this, "Type more than two letters!", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
