...
public class TechnologyActivity extends AppCompatActivity implements  SwipeRefreshLayout.OnRefreshListener{
    String country = "id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Berita Teknologi");
    ...
    public void LoadJson(final String keyword){
        ...
        if (keyword.length() > 0 ){
            call = apiInterface.getNewsSearch(keyword, language, "technology", API_KEY);
        } else {
    ...
    private void initListener(){
        ...
        adapter.setOnItemClickListener(new Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                ActivityOptionsCompat optionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation(TechnologyActivity.this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (query.length() > 2){
                    ...
                    Toast.makeText(TechnologyActivity.this, "Type more than two letters!", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
