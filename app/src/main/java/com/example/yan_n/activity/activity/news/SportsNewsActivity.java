...
public class SportsNewsActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    String country = "id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Berita Olahraga");
        ...
        layoutManager = new LinearLayoutManager(SportsNewsActivity.this);
    ...
    public void LoadJson(final String keyword){
        ...
        if (keyword.length() > 0 ){
            call = apiInterface.getNewsSearch(keyword, language, "sport", API_KEY);
        } else {
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(Call<News> call, Response<News> response) {
                if (response.isSuccessful() && response.body().getArticle() != null){
                    ...
                    adapter = new Adapter(articles, SportsNewsActivity.this);
    ...
    private void initListener(){
        ...
        adapter.setOnItemClickListener(new Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                ActivityOptionsCompat optionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation(SportsNewsActivity.this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (query.length() > 2){
                    ...
                    Toast.makeText(SportsNewsActivity.this, "Type more than two letters!", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
