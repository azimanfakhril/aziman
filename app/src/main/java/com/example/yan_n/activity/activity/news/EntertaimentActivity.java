...
public class EntertaimentActivity extends AppCompatActivity implements  SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Berita Entertaiment");
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(EntertaimentActivity.this);
        ...
        call.enqueue(new Callback<News>() {
            ...
            public void onResponse(@NonNull Call<News> call, @NonNull Response<News> response) {
                if (response.isSuccessful() && Objects.requireNonNull(response.body()).getArticle() != null) {
                    ...
                    adapter = new Adapter(articles, EntertaimentActivity.this);
            ...
            public void onFailure(@NonNull Call<News> call, Throwable t) {
                ...
                showErrorMessage(
                        R.drawable.oops,
                        "Oops..",
                        "Tidak ada akksses internet, Coba Kembali\n" +
                                t);
            }
        });
    }
    ...
    private void initListener() {
        adapter.setOnItemClickListener((view, position) -> {
            ...
            optionsCompat = ActivityOptionsCompat.makeSceneTransitionAnimation(EntertaimentActivity.this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (query.length() > 2) {
                    ...
                    Toast.makeText(EntertaimentActivity.this, "Ketik lebih dari dua huruf!", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
