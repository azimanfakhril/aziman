package com.example.yan_n.adapter;
...
public class RecyclerViewCryptoAdapter extends RecyclerView.Adapter<RecyclerViewCryptoAdapter.ViewHolder> {
    ...
    public RecyclerViewCryptoAdapter(ArrayList<String> mCoinNames,
                                     Context mContext,
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.crypto_layout_list, viewGroup, false);
